...
class Container(api_hour.Container):
    def __init__(self, *args, **kwargs):
        ...
        # self.current_ssh_text = ''
        # Text typed via SSH
        # Can't use that, no reference of
        # SSHServerConnection in InternalSSHServer

        ## Servers
        # You can define several servers, to listen HTTP and SSH
        # for example.
        # If you do that, you need to listen on two ports with api_hour
        #  --bind command line.
